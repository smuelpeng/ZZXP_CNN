...
option(USE_MKL "Use MKL2017 support" OFF)
...
elseif(ANDROID)
  ...
  set(LOCAL_SOFTWARE_PATH "/home/safe_data_dir_2/yuzhipeng/SDK_DENPEND/")
  include_directories(${CMAKE_CURRENT_LIST_DIR}/include)
  include_directories(${LOCAL_SOFTWARE_PATH}/include)
  include_directories(${CMAKE_CURRENT_LIST_DIR}/mklml_lnx_2018.0.20170908/include)
  if(USE_MKL)
      add_definitions(-DUSE_MKL)
      list(APPEND Caffe_LINKER_LIBS protobuf iomp5  mklml_gnu  mklml_intel)
    link_directories(${CMAKE_CURRENT_LIST_DIR}/mklml_lnx_2018.0.20170908/lib)
    link_directories(${LOCAL_SOFTWARE_PATH}/lib)
  else(USE_MKL)
...
if(USE_MKL)
file(GLOB CAFFE_SRC_MKL ${CMAKE_CURRENT_LIST_DIR}/src/layers/mkl/*.hpp
                         ${CMAKE_CURRENT_LIST_DIR}/src/layers/mkl/*.cpp)
list(APPEND CAFFE_COMPILE_CODE ${CAFFE_SRC_MKL})
endif(USE_MKL)
